...
class GatyaScene: SKScene{
    ...
    override init(size: CGSize) {
        ...
        let backTexture = SKTexture(image: ImageRealm.get(imageNamed: "trumpBack.png")!)
        ...
        //let audioPath = URL(fileURLWithPath: Bundle.main.path(forResource: "CardFlip", ofType: "wav")!)
        do{
