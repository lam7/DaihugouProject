...
//}
//
//@objc protocol UICountingLabelDelegate{
//    @objc optional func completion(_ countingLabel: UICountingLabel)
//}
//
//open class UICountingLabel: UILabel {
//    
//    public var format = "%f"
