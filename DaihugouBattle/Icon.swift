...
public class Icon : NSObject {
    ...
    @objc dynamic public class func drawCanvas2(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 50, height: 50), resizing: ResizingBehavior = .aspectFit, angleGiar: CGFloat = 47) {
        ...
        //// Color Declarations
        let giarColor = UIColor(red: 0.000, green: 0.447, blue: 0.682, alpha: 1.000)
        let giarStickColor = UIColor(red: 0.000, green: 0.585, blue: 1.000, alpha: 1.000)
        ...
        bezier8Path.move(to: CGPoint(x: -0, y: -5))
        bezier8Path.addLine(to: CGPoint(x: -0, y: -10))
        bezier8Path.move(to: CGPoint(x: -0, y: 10))
        bezier8Path.addLine(to: CGPoint(x: -0, y: 5))
        bezier8Path.move(to: CGPoint(x: -5, y: 0))
        bezier8Path.addLine(to: CGPoint(x: -10.5, y: 0))
        bezier8Path.move(to: CGPoint(x: 10, y: 0))
        bezier8Path.addLine(to: CGPoint(x: 4.5, y: 0))
    ...
    @objc dynamic public class func drawCanvas1(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 50, height: 50), resizing: ResizingBehavior = .aspectFit, angleSword: CGFloat = -46) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// Color Declarations
        let swordColor = UIColor(red: 0.000, green: 0.447, blue: 0.682, alpha: 1.000)
    ...
    @objc dynamic public class func drawCanvas3(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 50, height: 50), resizing: ResizingBehavior = .aspectFit, effect: CGFloat = 475, sizeDiamond: CGFloat = 1) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// Color Declarations
        let diamondColor = UIColor(red: 0.000, green: 0.447, blue: 0.682, alpha: 1.000)
        let startColor = UIColor(red: 1.000, green: 0.870, blue: 0.000, alpha: 1.000)

        //// Variable Declarations
        let effect1 = fmod(effect, 4) == 1 || fmod(effect, 4) == 2 || fmod(effect, 4) == 3
        let effect2 = fmod(effect, 4) == 2 || fmod(effect, 4) == 3
        let effect3 = fmod(effect, 4) == 3

        //// Bezier Drawing
        context.saveGState()
        context.translateBy(x: 25, y: 34)
        ...
        if (effect1) {
            ...
            starPath.move(to: CGPoint(x: 15, y: 9))
            starPath.addLine(to: CGPoint(x: 15.47, y: 12.35))
            starPath.addLine(to: CGPoint(x: 18.8, y: 11.76))
            starPath.addLine(to: CGPoint(x: 15.76, y: 13.25))
            starPath.addLine(to: CGPoint(x: 17.35, y: 16.24))
            starPath.addLine(to: CGPoint(x: 15, y: 13.8))
            starPath.addLine(to: CGPoint(x: 12.65, y: 16.24))
            starPath.addLine(to: CGPoint(x: 14.24, y: 13.25))
            starPath.addLine(to: CGPoint(x: 11.2, y: 11.76))
            starPath.addLine(to: CGPoint(x: 14.53, y: 12.35))
            starPath.close()
            startColor.setFill()
            starPath.fill()
        }
        ...
        if (effect2) {
            ...
            star2Path.move(to: CGPoint(x: 25, y: 3))
            star2Path.addLine(to: CGPoint(x: 25.47, y: 6.35))
            star2Path.addLine(to: CGPoint(x: 28.8, y: 5.76))
            star2Path.addLine(to: CGPoint(x: 25.76, y: 7.25))
            star2Path.addLine(to: CGPoint(x: 27.35, y: 10.24))
            star2Path.addLine(to: CGPoint(x: 25, y: 7.8))
            star2Path.addLine(to: CGPoint(x: 22.65, y: 10.24))
            star2Path.addLine(to: CGPoint(x: 24.24, y: 7.25))
            star2Path.addLine(to: CGPoint(x: 21.2, y: 5.76))
            star2Path.addLine(to: CGPoint(x: 24.53, y: 6.35))
            star2Path.close()
            startColor.setFill()
            star2Path.fill()
        }
        ...
        if (effect3) {
            ...
            star3Path.move(to: CGPoint(x: 34.5, y: 9))
            star3Path.addLine(to: CGPoint(x: 34.97, y: 12.35))
            star3Path.addLine(to: CGPoint(x: 38.3, y: 11.76))
            star3Path.addLine(to: CGPoint(x: 35.26, y: 13.25))
            star3Path.addLine(to: CGPoint(x: 36.85, y: 16.24))
            star3Path.addLine(to: CGPoint(x: 34.5, y: 13.8))
            star3Path.addLine(to: CGPoint(x: 32.15, y: 16.24))
            star3Path.addLine(to: CGPoint(x: 33.74, y: 13.25))
            star3Path.addLine(to: CGPoint(x: 30.7, y: 11.76))
            star3Path.addLine(to: CGPoint(x: 34.03, y: 12.35))
            star3Path.close()
            startColor.setFill()
            star3Path.fill()
        }
    ...
    //WARNING: Drawing method for 'Canvas 4' cannot be generated due to Trial limits.

    //WARNING: Drawing method for 'Canvas 5' cannot be generated due to Trial limits.
